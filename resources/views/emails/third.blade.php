...
<![endif]-->
<!--[if !mso]><!-->
  <body class="full-padding" style="margin: 0;padding: 0;min-width: 100%;background-color: #171f24;">
<!--<![endif]-->
    {!! EmailerHelpers::generateTrackingPixel($emailer_id) !!}
    <center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #171f24;">
      <table class="preheader" style="border-collapse: collapse;border-spacing: 0;width: 100%;background-color: #11171b;">
        <tbody><tr>
          
          <td class="webversion" style="padding: 9px;vertical-align: top;font-family: Ubuntu,sans-serif;color: #e6e6e6;font-size: 11px;line-height: 16px;text-align: right;width: 250px;">
      ...
      <div class="spacer" style="font-size: 1px;line-height: 20px;width: 100%;">&nbsp;</div>
          ...
          <table class="one-col-feature-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
            ...
            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: Ubuntu,sans-serif;color: #e0dce0;" align="center">
              <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 900px;" src="http://lumen.letsbuildafire.com/emailer-assets/third/images/DeathtoStock_NotStock6.jpg" alt="" width="600" height="400" />
            </div>
            ...
            <p style="font-style: normal;font-weight: 400;Margin-bottom: 32px;Margin-top: 0;font-size: 14px;line-height: 22px;font-family: Ubuntu,sans-serif;color: #e0dce0;text-align: center;">{!! $content or "Have you checked your denim inventory lately? Denim is one of this season's top trends and we've got the scoop on the latest must-haves straight from fashion week to your closet.&nbsp;" !!}</p>
            ...
            <p style="font-style: normal;font-weight: 400;Margin-bottom: 32px;Margin-top: 0;font-size: 14px;line-height: 22px;font-family: Ubuntu,sans-serif;color: #e0dce0;text-align: center;">{!! $signature !!}</p>
          ...
          <table class="two-col-bg" style="border-collapse: collapse;border-spacing: 0;width: 100%;">
            ...
            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: Ubuntu,sans-serif;color: #e0dce0;" align="center">
              <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 454px;" src="http://lumen.letsbuildafire.com/emailer-assets/third/images/photo-1423753623104-718aaace6772.jpg" alt="" width="290" height="291" />
            </div>
            ...
            <h1 style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 32px;font-size: 30px;line-height: 40px;font-family: Ubuntu,sans-serif;color: #80bfc4;">Henleys</h1><p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 16px;font-size: 14px;line-height: 22px;font-family: Ubuntu,sans-serif;color: #e0dce0;"><strong style="font-weight: bold;">Every man needs one</strong></p><p style="font-style: normal;font-weight: 400;Margin-bottom: 32px;Margin-top: 32px;font-size: 14px;line-height: 22px;font-family: Ubuntu,sans-serif;color: #e0dce0;">The Henley is this season's top pick for the man that wants an alternative to the classic v-neck t-shirt. Whether you pair it with a blazer for a sophisticated &nbsp;look or wear it plain for a more casual look, the Henley is a great way to upgrade your wardrobe.</p>
            ...
            <div class="image" style="font-size: 12px;mso-line-height-rule: at-least;font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 0;font-family: Ubuntu,sans-serif;color: #e0dce0;" align="center">
              <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;-ms-interpolation-mode: bicubic;display: block;max-width: 454px;" src="http://lumen.letsbuildafire.com/emailer-assets/third/images/outwear1.jpg" alt="" width="290" height="291" />
            </div>
            ...
            <h1 style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 32px;font-size: 30px;line-height: 40px;font-family: Ubuntu,sans-serif;color: #80bfc4;">Cardigans</h1><p style="font-style: normal;font-weight: 400;Margin-bottom: 0;Margin-top: 16px;font-size: 14px;line-height: 22px;font-family: Ubuntu,sans-serif;color: #e0dce0;"><strong style="font-weight: bold;">Making a comeback</strong></p><p style="font-style: normal;font-weight: 400;Margin-bottom: 32px;Margin-top: 32px;font-size: 14px;line-height: 22px;font-family: Ubuntu,sans-serif;color: #e0dce0;">This season, cardigans in earth tones are all the rage. Great for any occasion, the cardigan is an essential item for every woman's wardrobe. Solid colors are especially handy to mix and match and reuse for daywear or even a night out.&nbsp;</p>
            ...
            <div class="btn btn--left" style="Margin-bottom: 0;Margin-top: 0;text-align: left;">
              <![if !mso]><a style="border-radius: 3px;display: inline-block;font-size: 12px;font-weight: 700;line-height: 22px;padding: 10px 28px;text-align: center;text-decoration: none !important;transition: opacity 0.2s ease-in;color: #1e1e1e;font-family: Ubuntu,sans-serif;background-color: #80bfc4;" href="http://google.com">Cardigans</a><![endif]>
            <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://google.com" style="width:115px" arcsize="8%" fillcolor="#80BFC4" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,9px,0px,9px"><center style="font-size:12px;line-height:22px;color:#1E1E1E;font-family:sans-serif;font-weight:700;mso-line-height-rule:exactly;mso-text-raise:4px">Cardigans</center></v:textbox></v:roundrect><![endif]--></div>
              ...
              <tbody><tr>
                <td style="padding: 0;vertical-align: top;color: #e6e6e6;font-size: 12px;line-height: 22px;text-align: left;width: 400px;">
                  ...
                  <div class="campaign" style="font-family: Ubuntu,sans-serif;Margin-bottom: 18px;">
                    <span>
                      <a href="{{ EmailerHelpers::generateRedirectLink($emailer_id, 'http://apple.com') }}" lang="en">Preferences</a>
                    </span>
                    <span>
                      <a href="{{ EmailerHelpers::generateUnsubscribeLink($emailer_id) }}" lang="en">Unsubscribe</a>
                    </span>
                  </div>
                  </div>
                </td>
