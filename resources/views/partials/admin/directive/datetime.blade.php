<div ng-class="modeClass()" class="time-date la-time-date">
    ...
    <div class="control">
        ...
        <div class="slider">
            <div class="date-control">
                <div class="title">
                    <md-button ng-click="calendar._incMonth(-1)" aria-label="@{{:: translations.previousMonth}}" style="float: left;" ng-class="{'visuallyhidden': calendar.isVisibleMonthButton('mindate')}" class="md-mini md-flat md-primary month-page">
                        <md-icon class="material-icons">&#xE314;</md-icon>
                    </md-button>
                    <span class="month-part">@{{date | date:'MMMM'}}
                    ...
                    <md-button ng-click="calendar._incMonth(1)" aria-label="@{{:: translations.nextMonth}}" style="float: right;" ng-class="{'visuallyhidden': calendar.isVisibleMonthButton('maxdate')}" class="md-mini md-flat md-primary month-page">
                        <md-icon class="material-icons">&#xE315;</md-icon>
                    </md-button>
                </div>
                <div class="headers">
            ...
            <md-button type="button" ng-click="modeSwitch()" aria-label="@{{modeSwitchText()}}" class="switch-control"><i class="fa fa-clock-o"></i><i class="fa fa-calendar"></i><span class="visuallyhidden">@{{modeSwitchText()}}</span>
            </md-button>
            <div class="time-control">
                <div class="time-inputs">
                    <input type="tel" min="@{{_hours24 ? 0 : 1}}" max="@{{_hours24 ? 23 : 12}}" ng-model="clock._hours" />
                    ...
                    <input type="tel" min="0" max="59" ng-model="clock._minutes" />
                ...
                <div ng-if="!_hours24" class="buttons">
                    <md-button type="button" ng-click="clock.setAM()" aria-label="@{{:: translations.switchAmPm}}" class="am-pm-toggle">
                        @{{date | date:'a'}}
                        <span class="is-pm" ng-show="!clock.isAM()"> | AM</span>
                        <span class="is-am" ng-show="clock.isAM()"> | PM</span>
                    </md-button>
                </div>
            </div>
        </div>
