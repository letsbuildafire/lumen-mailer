		...
		return {
			...
			link: function(scope, element, attrs, ngModel){
				...
				if(attrs.taTargetToolbars) _toolbars = textAngularManager.registerEditor(scope._name, scope, attrs.taTargetToolbars.split(','));
					...
					var _toolbar = angular.element('<md-toolbar text-angular-toolbar name="textAngularToolbar' + _serial + '">');
		...
		return {
			...
			link: function(scope, element, attrs){
				...
				var setupToolElement = function(toolDefinition, toolScope){
					...
					else toolElement = angular.element("<md-button class='md-mini md-raised md-primary' type='button'>");
					...
					if(toolDefinition && !toolDefinition.display && !toolScope._display){
						...
						if(toolDefinition.iconclass){
							var icon = angular.element("<md-icon>" + toolDefinition.buttontext + "</md-icon>"), content = toolElement[0].innerHTML;
							icon.addClass(toolDefinition.iconclass);
							icon.attr('aria-label', toolScope.name);
							toolElement[0].innerHTML = '';
